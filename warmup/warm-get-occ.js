...
module.exports.getOcc = (event, context) => {

  console.log('Executing: getOcc');

  const params = {
    FunctionName: process.env.func_prefix + 'getoccupation', // the lambda function we are going to invoke
